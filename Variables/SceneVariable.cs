...
namespace ScriptableObjectArchitecture.Variables
{
    ...
    [CreateAssetMenu(
        ...
        menuName = SoArchitectureUtility.ADVANCED_VARIABLE_SUBMENU + "Scene",
        order = 120)]
    ...
    public sealed class SceneInfo : ISerializationCallbackReceiver
    {
        ...
        #if UNITY_EDITOR
        internal UnityEditor.SceneAsset Scene => UnityEditor.AssetDatabase.LoadAssetAtPath<UnityEditor.SceneAsset>(_sceneName);
#endif
